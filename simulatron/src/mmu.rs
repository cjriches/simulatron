...
mod tests {
    ...
    fn test_address_translation() {
        ...
        // Set PDPR.
        fixture.mmu.set_page_directory_pointer_register(RAM_BASE);
        ...
        assert_eq!(fixture.mmu.virtual_to_physical_address(0, Intent::Read), Some(0x00006000));
    }
    ...
    fn test_address_translation_external_interface() {
        ...
        // Set PDPR.
        fixture.mmu.set_page_directory_pointer_register(0x00100000);
        // Write a single page directory and page table entry.
        ...
        fixture.mmu.store_virtual_8(0, 0x55);
        fixture.mmu.store_virtual_32(1, 0xDEADBEEF);
    ...
    fn test_invalid_page_fault() {
        ...
        assert_eq!(fixture.mmu.virtual_to_physical_address(0, Intent::Read), None);
        assert_eq!(fixture.mmu.virtual_to_physical_address(1246, Intent::Write), None);
        assert_eq!(fixture.mmu.virtual_to_physical_address(678424657, Intent::Execute), None);
        ...
        assert_eq!(fixture.mmu.virtual_to_physical_address(0x0000, Intent::Read), None);
        assert_eq!(fixture.mmu.virtual_to_physical_address(0x1000, Intent::Write), None);
        assert_eq!(fixture.mmu.virtual_to_physical_address(0x2000, Intent::Execute), None);
        // Also test one where we didn't write a page entry.
        assert_eq!(fixture.mmu.virtual_to_physical_address(0x3000, Intent::Read), None);
    }
    ...
    fn test_invalid_page_fault_external_interface() {
        ...
        // Set PDPR.
        fixture.mmu.set_page_directory_pointer_register(0x00420000);
        // 0 is an invalid page directory entry; don't need to write anything.
        // Any translation should fail.
        assert_eq!(fixture.mmu.load_virtual_8(0, false), 0);
        ...
        assert_eq!(fixture.mmu.load_virtual_16(0x1000, true), 0);
        assert_eq!(fixture.interrupt_rx.recv_timeout(Duration::from_millis(10)),
                   Ok(INTERRUPT_PAGE_FAULT));
        assert_eq!(fixture.mmu.page_fault_status_register(), PAGE_FAULT_INVALID_PAGE);
        fixture.mmu.store_virtual_32(0x10010, 420);
        assert_eq!(fixture.interrupt_rx.recv_timeout(Duration::from_millis(10)),
                   Ok(INTERRUPT_PAGE_FAULT));
        assert_eq!(fixture.mmu.page_fault_status_register(), PAGE_FAULT_INVALID_PAGE);
        ...
        // Any translation should still fail.
        assert_eq!(fixture.mmu.load_virtual_32(0x0000, false), 0);
        assert_eq!(fixture.interrupt_rx.recv_timeout(Duration::from_millis(10)),
                   Ok(INTERRUPT_PAGE_FAULT));
        assert_eq!(fixture.mmu.page_fault_status_register(), PAGE_FAULT_INVALID_PAGE);
        assert_eq!(fixture.mmu.load_virtual_32(0x1000, true), 0);
        assert_eq!(fixture.interrupt_rx.recv_timeout(Duration::from_millis(10)),
                   Ok(INTERRUPT_PAGE_FAULT));
        assert_eq!(fixture.mmu.page_fault_status_register(), PAGE_FAULT_INVALID_PAGE);
        fixture.mmu.store_virtual_8(0x2000, 99);
        assert_eq!(fixture.interrupt_rx.recv_timeout(Duration::from_millis(10)),
                   Ok(INTERRUPT_PAGE_FAULT));
        assert_eq!(fixture.mmu.page_fault_status_register(), PAGE_FAULT_INVALID_PAGE);
        // Also test one where we didn't write a page entry.
        fixture.mmu.store_virtual_16(0x3000, 5);
        assert_eq!(fixture.interrupt_rx.recv_timeout(Duration::from_millis(10)),
                   Ok(INTERRUPT_PAGE_FAULT));
        assert_eq!(fixture.mmu.page_fault_status_register(), PAGE_FAULT_INVALID_PAGE);
    }
    ...
    fn test_illegal_access_fault() {
        ...
        // Set PDPR.
        fixture.mmu.set_page_directory_pointer_register(0x00004000);
        ...
        assert_eq!(fixture.mmu.load_virtual_32(0x0000, false), 0);
        fixture.interrupt_rx.recv_timeout(Duration::from_millis(10)).unwrap_err();
        fixture.mmu.store_virtual_32(0x0000, 56);
        assert_eq!(fixture.interrupt_rx.recv_timeout(Duration::from_millis(10)),
                   Ok(INTERRUPT_PAGE_FAULT));
        assert_eq!(fixture.mmu.page_fault_status_register(), PAGE_FAULT_ILLEGAL_ACCESS);
        assert_eq!(fixture.mmu.load_virtual_32(0x0000, true), 0);
        assert_eq!(fixture.interrupt_rx.recv_timeout(Duration::from_millis(10)),
                   Ok(INTERRUPT_PAGE_FAULT));
        assert_eq!(fixture.mmu.page_fault_status_register(), PAGE_FAULT_ILLEGAL_ACCESS);

        // Second page entry should only allow write.
        assert_eq!(fixture.mmu.load_virtual_32(0x1000, false), 0);
        assert_eq!(fixture.interrupt_rx.recv_timeout(Duration::from_millis(10)),
                   Ok(INTERRUPT_PAGE_FAULT));
        assert_eq!(fixture.mmu.page_fault_status_register(), PAGE_FAULT_ILLEGAL_ACCESS);
        fixture.mmu.store_virtual_32(0x1000, 56);
        fixture.interrupt_rx.recv_timeout(Duration::from_millis(10)).unwrap_err();
        assert_eq!(fixture.mmu.load_virtual_32(0x1000, true), 0);
        assert_eq!(fixture.interrupt_rx.recv_timeout(Duration::from_millis(10)),
                   Ok(INTERRUPT_PAGE_FAULT));
        ...
        assert_eq!(fixture.mmu.load_virtual_32(0x2000, false), 0);
        assert_eq!(fixture.interrupt_rx.recv_timeout(Duration::from_millis(10)),
                   Ok(INTERRUPT_PAGE_FAULT));
        assert_eq!(fixture.mmu.page_fault_status_register(), PAGE_FAULT_ILLEGAL_ACCESS);
        fixture.mmu.store_virtual_32(0x2000, 56);
        assert_eq!(fixture.interrupt_rx.recv_timeout(Duration::from_millis(10)),
                   Ok(INTERRUPT_PAGE_FAULT));
        assert_eq!(fixture.mmu.page_fault_status_register(), PAGE_FAULT_ILLEGAL_ACCESS);
        assert_eq!(fixture.mmu.load_virtual_32(0x2000, true), 0);
        fixture.interrupt_rx.recv_timeout(Duration::from_millis(10)).unwrap_err();
    }
    ...
    fn test_not_present_fault() {
        ...
        assert_eq!(fixture.mmu.load_virtual_8(0x0FFF, false), 0);
        assert_eq!(fixture.interrupt_rx.recv_timeout(Duration::from_millis(10)),
                   Ok(INTERRUPT_PAGE_FAULT));
        ...
        assert_eq!(fixture.mmu.load_virtual_8(0x0FFF, true), 12);
        fixture.interrupt_rx.recv_timeout(Duration::from_millis(10)).unwrap_err();
    }
    ...
    fn test_cow_fault() {
        ...
        fixture.mmu.store_virtual_32(0x0123, 0x420);
        assert_eq!(fixture.interrupt_rx.recv_timeout(Duration::from_millis(10)),
                   Ok(INTERRUPT_PAGE_FAULT));
